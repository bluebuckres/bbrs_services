...
const team = [
    {
        ...
        desc: "Full-stack engineer and cloud architect. Specializes in building scalable SaaS platforms and complex data pipelines. Ex-fintech.",
    ...
    },
    {
        ...
        desc: "Machine learning engineer and data scientist. Specializes in LLM fine-tuning, computer vision, and predictive modeling.",
