    ...
    return (
        <header className="relative min-h-[80vh] flex items-center justify-center pt-20 overflow-hidden bg-[#fdfbf7]">
            ...
            <div className="relative z-10 max-w-5xl mx-auto px-6 text-center">
                <h1 className="font-display text-7xl md:text-9xl leading-none mb-8 bg-clip-text text-transparent bg-gradient-to-r from-purple-600 via-fuchsia-500 to-indigo-500">
